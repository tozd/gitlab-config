...
type GitLab struct {
	...
	DocsRef string `short:"D" name:"docs" placeholder:"REF" default:"master" env:"DOCS_GIT_REF" help:"Git reference at which to extract API attributes from documentation. Default is \"${default}\". Environment variable: ${env}"`
}
