...
type GitLab struct {
	...
	DocsRef string `short:"D" name:"docs" placeholder:"REF" default:"${defaultDocsRef}" env:"DOCS_GIT_REF" help:"Git reference at which to extract API attributes from GitLab's documentation. Default is \"${defaultDocsRef}\". Environment variable: ${env}"`
}
